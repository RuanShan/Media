class Pro::BusinessShopsController < WebsiteShared::WebsiteBaseController
  ...
  def new
    ...
    @business_shop.build_activity(site: current_site, wx_mp_user: current_site.wx_mp_user, activity_type_id: ActivityType::BUSINESS_SHOP, status: Activity::STATUS_SETTED)
    render :form
  end
