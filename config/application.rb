...
module Wp
  class Application < Rails::Application
    ...
    config.eager_load_paths += %w(lib app/api app/models/payment_settings app/models/concerns app/controllers/concerns app/validators app/services).map { |path| "#{Rails.root}/#{path}" }
